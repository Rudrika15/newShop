                    ...
                    <table id="slider-table" class="table table-bordered text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('images/slider/' . $slider->sliderImage) }}" width="50"
                                        height="50"></td>
                                <td>
                ...
                button.addEventListener('click', (e) => {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = `/sldier/force-delete/${userId}`;
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href = `/slider/restore/${userId}`;
                                Swal.fire('Restored!', 'Slider Restored Successfully.', 'success');
                                    }
                                });
                            }
                        });
