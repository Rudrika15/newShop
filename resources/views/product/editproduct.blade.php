        ...
        <form method="POST" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data">
            ...
            <div class="row border border-dark p-3 m-3">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="checkbox" id="is_active" name="is_active" value="Yes" {{ old('is_active',
                            $product->is_active) === 'Yes' ? 'checked' : '' }}>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="text" name="mrp" id="mrp" value="{{ $product->mrp }}">
                        <span class="text-danger">
                            @error('mrp')
                            {{ $message }}
                            @enderror
            ...
            <div class="row border border-dark p-3 m-3">
                <div class="row mb-3">
                    ...
                    <div class="col-md-1 ">
                        @if ('{{ $product->image }}')
                        <img src="{{ asset('images/product/' . $product->image) }}" width="70" height="70"><br>
                        @else
                        <p>No image found</p>
                        @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select id="sku" name="sku" class="form-select sku-input" disabled>
                            @foreach ($skus as $sku)
                            <option value="{{ $sku->prefix }}" data-color="{{ $sku->colorname }}" {{ $product->sku ==
                                $sku->prefix ? 'selected' : '' }}>
                                {{ $sku->prefix }}
                            </option>
                            @endforeach
