                ...
                <div class="card-body">
                    <div class="row m-0 p-3">
                        ...
                        <div class="col-lg-6 d-flex justify-content-end align-items-center">
                            <span style="float:right;"><a href="{{ route('sku.index') }}"
                                ...
                                <td>
                                    <div class="d-flex gap-2 justify-content-center">
                                        <div>
                                            ...
                                            {{-- <button class="sku-restore btn btn-danger btn-sm shadow-none"
                                                data-id="{{ $sku->id }}">Restore</button> --}}
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href = `/sku/restore/${userId}`;
                                Swal.fire('Restored!', 'SKU Restored Successfully.', 'success');
                                    }
                                });
                            }
                        });
